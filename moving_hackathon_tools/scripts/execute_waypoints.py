...
if __name__ == '__main__':
    ...
    commands_list = [
        "roslaunch waypoint_maker waypoint_loader.launch load_csv:=True multi_lane_csv:=/home/sam/moving_2019_ws/src/2easy_team/waypoints_data/missions/" + waypoints_csv +

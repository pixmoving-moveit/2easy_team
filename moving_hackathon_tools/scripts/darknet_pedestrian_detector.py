...
if __name__ == '__main__':
    ...
    commands_list = [
        "roslaunch vision_darknet_detect vision_yolo3_detect.launch image_src:=/camera0/image_raw",
        "rosrun pedestrian_detector detector.py"
    ]

    executed_commands = []
    for cmd in commands_list:
        if 'pedestrian_detector' not in cmd:
